...
//     if (formData.schedule_type === "weekly" && formData.schedule_days.length === 0) {
...
//                 {/* ✅ Show Date only if schedule_type = date */}
...
//                 {/* ✅ Show weekly checkboxes only if schedule_type = weekly */}
